                ...
                <div className="w-full mb-4">
                  {locationFields.length === 0 ? (
                    <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 rounded-lg">
                      <h3 className="text-lg font-medium text-gray-600 mb-3">No Locations Added</h3>
                      <p className="text-gray-500 text-center mb-6">
                        Add locations where this permit can be used. Each location can have different availability and pricing.
                      </p>
                      <Button
                        type="button"
                        variant="default"
